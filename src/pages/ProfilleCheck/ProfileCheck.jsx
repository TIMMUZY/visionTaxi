    ...
    return (
        <div>
            <header className={classes.header}>
                ...
                <img className={classes.notific} src={coco} alt="" />
                <img className={classes.proffo} src={proff} alt="" />
            </header>
            ...
            <div>
                <div className={classes.firstblock}>
                    ...
                    <button className={classes.changebtn}><p>Изменить</p><img className={classes.aura} src={change} alt="" /></button>
                </div>
                <div className={classes.importantblock}>
                    <div className={classes.firstcont}>
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                placeholder='Введите банковскую карту'
                            />
                        </div>
                        <div>
                            <h3>Банковская карта</h3>
                    ...
                    <div className={classes.secondcont}>
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                placeholder='Выберите свой класс машин'
                            />
                        </div>
                        <div>
                        ...
                        <div className={classes.miniinfo}>
                            <h2>Проверка Фото </h2>
                            <button className={classes.onlybtn}>Перейти</button>
                        </div>
                    </div>
                </div>
            </div>
